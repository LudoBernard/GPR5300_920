...
namespace gpr5300
{
	...
	{
		//Load shaders
		const auto vertexContent = gpr5300::LoadFile("data/shaders/my_scene/my_scene.vert");
		...
		const auto fragmentContent = gpr5300::LoadFile("data/shaders/my_scene/my_scene.frag");
