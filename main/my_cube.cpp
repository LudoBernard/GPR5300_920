...
namespace gpr5300
{
	...
	public:
		...
		{
			//Load shaders
			const auto vertexContent = LoadFile("data/shaders/my_cube/my_cube.vert");
			...
			const auto fragmentContent = LoadFile("data/shaders/my_cube/my_cube.frag");
	...
	void CubeScene::Begin()
	{
		...
		texture_.CreateTexture("data/textures/lava2.jpg");
		mesh_.Generate();
